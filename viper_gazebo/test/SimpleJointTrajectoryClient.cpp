...
#define JOINT_TRAJECTORY_ACTION_TOPIC "/viper/joint_trajectory_action"
#define JOINT_STATES_TOPIC "/viper/joint_state"
...
{
    ros::init(argc, argv, "viper_joint_trajectory_client");
